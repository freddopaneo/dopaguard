export default function ArticleBody() {
  return (
    <>
      ...
      <h2 className="font-semibold text-dopaguard-navy">L&apos;IA s&apos;impose comme étape de recherche avant l&apos;achat</h2>
      <p>
      ...
      <h2 className="font-semibold text-dopaguard-navy">Le risque d&apos;une fiche produit ou d&apos;un tarif obsolète</h2>
      <p>
      ...
      <ul className="list-disc pl-5">
        <li>Prix affiché par l&apos;IA différent du prix réel en boutique en ligne.</li>
        <li>Frais de port, délais de livraison ou zones desservies mal décrits.</li>
        <li>Gamme de produits incomplète ou abandonnée présentée comme actuelle.</li>
        <li>Politique de retour ou garantie décrite de façon erronée.</li>
      </ul>
      <h2 className="font-semibold text-dopaguard-navy">Le risque plus grave : l&apos;IA recommande un concurrent</h2>
      <p>
      ...
      <h2 className="font-semibold text-dopaguard-navy">Un désavantage qui pèse plus lourd pour les petites marques e-commerce</h2>
      <p>
      ...
      <h2 className="font-semibold text-dopaguard-navy">La fiche de vérité et le contrôle hebdomadaire comme réponse</h2>
      <p>
      ...
      <p>
        Dopaguard propose un scan gratuit de trois minutes, sans carte bancaire, pour découvrir en quelques minutes ce que les IA disent déjà de votre boutique en ligne. Le plan Essentiel à 69€ par mois surveille trois IA chaque semaine, le plan Pro à 149€ par mois ajoute deux IA supplémentaires ainsi qu&apos;un suivi comparatif d&apos;un concurrent, et le plan Agence à 349€ par mois s&apos;adresse aux agences et consultants qui accompagnent plusieurs boutiques en parallèle, avec des rapports en marque blanche pour jusqu&apos;à dix marques.
      </p>
      <p>
