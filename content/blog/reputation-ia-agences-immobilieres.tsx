export default function ArticleBody() {
  return (
    <>
      <p>
        Un couple cherche un appartement dans votre quartier depuis trois semaines. Avant de composer votre numéro, l&apos;un des deux ouvre ChatGPT sur son téléphone et tape : &laquo; que sais-tu de l&apos;agence [nom] à [ville] ? &raquo;. La réponse arrive en quelques secondes, avec un ton assuré, parfois une comparaison avec une autre agence du secteur. Vous ne saurez jamais que cette conversation a eu lieu, ni ce qu&apos;elle a dit exactement. Et pourtant, elle vient peut-être de décider si ce couple vous appelle ou compose un autre numéro.
      </p>
      <h2 className="font-semibold text-dopaguard-navy">Avant de pousser votre porte, ils interrogent une IA</h2>
      <p>
      ...
      <h2 className="font-semibold text-dopaguard-navy">Le risque bien réel de confusion entre agences voisines</h2>
      <p>
      ...
      <ul className="list-disc pl-5">
        <li>Deux agences aux noms proches dans la même ville ou le même arrondissement.</li>
        <li>Un réseau national et une agence indépendante partageant un nom de famille ou un toponyme commun.</li>
        <li>Une ancienne enseigne rachetée ou renommée, dont l&apos;IA continue de mélanger l&apos;identité avec la nouvelle.</li>
        <li>Des zones d&apos;intervention qui se chevauchent, menant l&apos;IA à attribuer un secteur à la mauvaise agence.</li>
      </ul>
      <h2 className="font-semibold text-dopaguard-navy">Des informations obsolètes qui continuent de circuler</h2>
      <p>
      ...
      <h2 className="font-semibold text-dopaguard-navy">Pourquoi l&apos;immobilier local se joue sur la confiance et la première impression</h2>
      <p>
      ...
      <h2 className="font-semibold text-dopaguard-navy">Repérer le problème avant qu&apos;il ne coûte un contact</h2>
      <p>
